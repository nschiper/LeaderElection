...
#ifndef VARIABLES_EXCHANGE_LIB
#define VARIABLES_EXCHANGE_LIB
...
struct bestAmongActives_struct {
  u_int pid;
...
inline int insert_remotevars_in_list(struct sockaddr_in *addr, u_int gid, struct timeval *accusationTime,
  struct bestAmongActives_struct *bestAmongActives,
struct timeval *bestAmongActives_accTime, struct list_head *remotevars);
